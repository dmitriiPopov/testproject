...
class CommentsController extends Controller
{
    ...
    public function actionCreate($articleId)
    {
        ...
        4) нажимаю "оставить комментарий" и появляется валидационная ошибка под незаполненным полем content (тут все ок)
        ...
        //TODO: и еще есть ошибка
        /**
         * 1) добавляю комментарий - добавляется комментарий в список
         * 2) нажимаю Редактировать - данные добавлены в форму
         * 3) удаляю комментарий из списка
         * 4) нажимаю "Изменить комментарий" в уже заполненной форме и получаю ошибку (см. запрос в консоли браузера)
         * Решение: если я удаляю комментарий, то просто всегда очищай форму (возвращай ее к состоянию как при создании комментария)
         */
